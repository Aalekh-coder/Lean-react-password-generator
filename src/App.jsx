...
const App = () => {
  ...
  return (
    <div className="w-full max-w-mg mx-auto shadow-md rounded-lg px-4 my-8 py-4  bg-gray-700">
      <h1 className="text-center text-4xl mt-10 my-3">Password-Generator</h1>
